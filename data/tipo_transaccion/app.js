angular.module('scotchApp').controller('tipo_transaccionController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipo_transaccion/xml_tipo_transaccion.php',
	        autoencode: false,
	        datatype: "xml",
			height: 330,
			colNames:['ID','ABREVIATURA','TRANSACCIÓN','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
				...
				{name:'nombre_transaccion',index:'nombre_transaccion',width:150, editable:true, editoptions:{size:"", maxlength:""}, editrules: {required: true}},
	        ...
	        editurl: "data/tipo_transaccion/app.php",
	        caption: "LISTA TIPOS DE TRANSACCIÓN"
	    });
	        ...
	        afterSubmit: function(response)  {
                ...
                if(retorno == '2'){
                	...
                	if(retorno == '3') {
	                	...
	                	return [false,"Error.. El Tipo de Transacción ya fue Agregado"];
	                }
                }
                return [true,'',retorno];
            },
