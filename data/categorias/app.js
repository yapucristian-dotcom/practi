angular.module('scotchApp').controller('categoriasController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/categorias/xml_categorias.php',
	        autoencode: false,
	        datatype: "xml",
			height: 330,
			colNames:['ID','CATEGORIA','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
	        ...
	        editurl: "data/categorias/app.php",
	        ...
	        afterSubmit: function(response)  {
                ...
                if(retorno == '2'){
                	...
                	if(retorno == '3') {
	                	...
	                	return [false,"Error.. La Categoria ya fue Agregada"];
	                }
                }
                return [true,'',retorno];
            },
