angular.module('scotchApp').controller('egresosController', function ($scope, $interval) {
	...
	jQuery(function($) {
	    ...
	    function barras() {
            ...
            $.getJSON('data/egresos/search.php?codigo_barras=' + codigo_barras, function(data) {
            	if(data == null) {
					swal({
		...
		$scope.methodspdf = function(id) { 
			var myWindow = window.open('data/reportes/egreso.php?hoja=A5&id='+id,'popup','width=900,height=650');
		} 
		// fin
