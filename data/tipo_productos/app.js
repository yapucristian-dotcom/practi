angular.module('scotchApp').controller('tipo_productosController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/tipo_productos/xml_tipo_productos.php',
	        autoencode: false,
	        datatype: "xml",
			height: 330,
			colNames:['ID','TIPO PRODUCTO','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
	        ...
	        editurl: "data/tipo_productos/app.php",
	        caption: "LISTA TIPO DE PRODUCTOS"
	    });
