angular.module('scotchApp').controller('marcasController', function ($scope, $route) {
	...
	jQuery(function($) {
	    ...
	    jQuery(grid_selector).jqGrid({
	        url: 'data/marcas/xml_marcas.php',
	        autoencode: false,
	        datatype: "xml",
			height: 330,
			colNames:['ID','MARCA','PRINCIPAL','OBSERVACIONES','FECHA CREACIÓN'],
			colModel:[
	    ...
	    },
	    {
	        ...
	        afterSubmit: function(response)  {
                ...
                if(retorno == '2'){
                	...
                	if(retorno == '3') {
                		$("#nombre_marca").val("");
	                	return [false,"Error.. La Marca ya fue Agregada"];
	                }
                }
                return [true,'',retorno];
            },
